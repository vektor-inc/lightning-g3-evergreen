...
function vkb_register_required_plugins() {
	...
	$config = array(
		...
		'strings'      => array(
			...
			'installing'                      => __( 'Installing Plugin: %s', 'lightning-g3-evergreen' ),
			'oops'                            => __( 'Something went wrong with the plugin API.', 'lightning-g3-evergreen' ),
			// translators:
			...
			'return'                          => __( 'Return to Required Plugins Installer', 'lightning-g3-evergreen' ),
			'plugin_activated'                => __( 'Plugin activated successfully.', 'lightning-g3-evergreen' ),
			'activated_successfully'          => __( 'The following plugin was activated successfully:', 'lightning-g3-evergreen' ),
			// translators: %s = plugin name.
			'plugin_already_active'           => __( 'No action taken. Plugin %1$s was already active.', 'lightning-g3-evergreen' ),
			// translators: %s = plugin name.
			'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', 'lightning-g3-evergreen' ),
			// translators: %s = plugin name.
			'complete'                        => __( 'All plugins installed and activated successfully. %1$s', 'lightning-g3-evergreen' ),
			// translators: %s = dashboard link.
			'contact_admin'                   => __( 'Please contact the administrator of this site for help.', 'lightning-g3-evergreen' ),
